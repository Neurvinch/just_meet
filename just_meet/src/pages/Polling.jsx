...
const PixelPolling = () => {
  ...
  // Set up Socket.IO listeners and fetch initial polls
  useEffect(() => {
    // Load initial polls
    socket.on('initPolls', (initialPolls) => {
      setPolls(initialPolls);
    });

    // Update polls in real-time
    ...
    socket.on('connect_error', (err) => {
      ...
      setError('Failed to connect to the polling server');
    });
